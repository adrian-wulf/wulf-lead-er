...
KNOWN_CUSTOM_TRADES: dict[str, dict[str, Any]] = {
    ...
    "programista": {
        ...
        "osm": ["office=it", "office=company", "office=web_design"],
        "pkd": ["62.01.Z", "62.02.Z"],
        "wz": ["62.01", "62.02"],
    },
    "serwis_komputerowy": {
        ...
        "osm": ["shop=computer", "craft=electronics_repair", "craft=computer", "office=it"],
        "pkd": ["95.11.Z", "47.41.Z"],
        "wz": ["95.11", "47.41"],
    },
    "tworzenie_stron": {
    ...
    "agencja_marketingowa": {
        ...
        "osm": ["office=advertising_agency", "office=it", "office=graphic_design"],
        "pkd": ["73.11.Z"],
        "wz": ["73.11"],
    },
    ...
    "pediatra": {
        ...
        "osm": ["amenity=doctors", "healthcare=doctor", "healthcare:speciality=paediatrics"],
        "pkd": ["86.21.Z", "86.22.Z"],
        "wz": ["86.21", "86.22"],
    },
    "ginekolog": {
        ...
        "osm": ["amenity=doctors", "healthcare=doctor", "healthcare:speciality=gynaecology"],
        "pkd": ["86.22.Z"],
        "wz": ["86.22"],
    },
    "okulista": {
        ...
        "osm": ["amenity=doctors", "healthcare=doctor", "healthcare:speciality=ophthalmology", "shop=optician"],
        "pkd": ["86.22.Z", "47.78.Z"],
        "wz": ["86.22", "47.78"],
    },
    "dermatolog": {
        ...
        "osm": ["amenity=doctors", "healthcare=doctor", "healthcare:speciality=dermatology"],
        "pkd": ["86.22.Z"],
        "wz": ["86.22"],
    },
    "kardiolog": {
        ...
        "osm": ["amenity=doctors", "healthcare=doctor", "healthcare:speciality=cardiology"],
        "pkd": ["86.22.Z"],
        "wz": ["86.22"],
    },
    "ortopeda": {
        ...
        "osm": ["amenity=doctors", "healthcare=doctor", "healthcare:speciality=orthopaedics"],
        "pkd": ["86.22.Z"],
        "wz": ["86.22"],
    },
    "psycholog": {
        ...
        "osm": ["amenity=doctors", "healthcare=psychotherapist", "healthcare=counselling", "office=therapist"],
        "pkd": ["86.90.E", "86.22.Z"],
        "wz": ["86.90", "86.22"],
    },
    "stomatolog": {
    ...
    "wulkanizacja": {
        ...
        "osm": ["shop=tyres", "shop=car_repair", "craft=car_repair"],
        "pkd": ["45.20.Z"],
        "wz": ["45.20"],
    },
    "myjnia": {
        ...
        "osm": ["amenity=car_wash", "craft=car_repair"],
        "pkd": ["45.20.Z"],
        "wz": ["45.20"],
    },
    "pomoc_drogowa": {
        ...
        "osm": ["craft=towing", "shop=car_repair"],
        "pkd": ["52.21.Z"],
        "wz": ["52.21"],
    },
    "stacja_kontroli_pojazdow": {
        ...
        "osm": ["amenity=vehicle_inspection", "shop=car_repair"],
        "pkd": ["71.20.B"],
        "wz": ["71.20"],
    },
    ...
    "catering": {
        ...
        "osm": ["craft=caterer", "amenity=restaurant"],
        "pkd": ["56.21.Z", "56.29.Z"],
        "wz": ["56.21", "56.29"],
    },
    "hotel": {
    ...
    "szkola_jezykowa": {
        ...
        "osm": ["amenity=language_school", "amenity=school"],
        "pkd": ["85.59.A"],
        "wz": ["85.59"],
    },
    "przedszkole": {
    ...
    "basen": {
        ...
        "osm": ["leisure=swimming_pool", "leisure=sports_centre"],
        "pkd": ["93.11.Z"],
        "wz": ["93.11"],
    },
}
